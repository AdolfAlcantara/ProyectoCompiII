...
#ifndef YY_YY_EXPR_PARSER_H_INCLUDED
# define YY_YY_EXPR_PARSER_H_INCLUDED
// "%code requires" blocks.
#line 13 "/home/deafdead/Documentos/compiII/proyecto/lexer_re2c_ast/expr.y"
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      symbol_type (int tok, std::string v)
        : super_type(token_type (tok), std::move (v))
      {
        YY_ASSERT (tok == token::TK_STRING || tok == token::TK_IDENTIFIER);
      }
#else
    ...
    Parser (Ast::Node*&root_yyarg, ExprLexer& lexer_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_OP_PWD ()
      {
        return symbol_type (token::OP_PWD);
      }
#else
      static
      symbol_type
      ...
      make_OP_GET ()
      {
        return symbol_type (token::OP_GET);
      }
#else
      static
      symbol_type
      ...
      make_OP_LET ()
      {
        return symbol_type (token::OP_LET);
      }
#else
      static
      symbol_type
      ...
      make_OP_NEQ ()
      {
        return symbol_type (token::OP_NEQ);
      }
#else
      static
      symbol_type
      ...
      make_TK_OPENPAR ()
      {
        return symbol_type (token::TK_OPENPAR);
      }
#else
      static
      symbol_type
      ...
      make_KW_DEF ()
      {
        return symbol_type (token::KW_DEF);
      }
#else
      static
      symbol_type
      ...
      make_KW_INPUT ()
      {
        return symbol_type (token::KW_INPUT);
      }
#else
      static
      symbol_type
      ...
      make_Dedent ()
      {
        return symbol_type (token::Dedent);
      }
#else
      static
      symbol_type
...
#endif // !YY_YY_EXPR_PARSER_H_INCLUDED
